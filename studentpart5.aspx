<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentpart5.aspx.cs" Inherits="studentpart5" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" Height="132px" Width="251px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:labassistsConnectionString6 %>" SelectCommand="SELECT * FROM [programs]"></asp:SqlDataSource>
